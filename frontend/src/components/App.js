            ...
            element={
              <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-4">
                <div className="text-center">
                  ...
                  <p className="text-xl text-gray-600 mb-8">Can't decide where to eat? We'll help! Enter your location and preferences, and we'll show you 5 random restaurants. Pick your top 3 favorites, then let us choose 1 for you. No more dinner debates—just great food.</p>
                  <Link
                    to="/start"
